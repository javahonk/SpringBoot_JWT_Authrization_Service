...
public class AuthSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.csrf().disable()
				...
				//.authorizeRequests().antMatchers("/authenticate"h").permitAll().
				.authorizeRequests().antMatchers("/authenticate","testGet","/health","/info","/metrics","/logfile","/env","/liquibase","/dump","/jolokia","/auditevents",
				"/flyway","/heapdump","/trace").permitAll().
